...
<html lang="en">
    <head>
        ...
        <title>yhvreddy - Portfolio Template</title>

        <!-- favicon -->
        <link href="{{asset('public/images/favicon.ico')}}" rel="icon" type="image/png">
    ...
    <body>
        ...
        <!--Home Section Start-->
        <section id="home" class="banner" style="background-image: url({{asset('public/images/background/home-banner-bg.jpg')}})" data-stellar-background-ratio=".7" data-scroll-index="0">
            <div class="container">
                <!--Banner Content-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-md-6">
                        <!--About Image-->
                        <div class="about-img">
                            <img src="{{asset('public/images/about-img.jpg')}}" alt="">
                        </div>
                    </div>
        ...
        <!--Stats Section Start-->
        <section class="stats pt-100 pb-100" style="background-image: url({{asset('public/images/background/stats-bg.jpg')}})">
            <div class="container">
                <div class="row">
                ...
                <div class="row portfolio-items">
                    ...
                    <div class="col-lg-4 col-md-6 item application">
                        <div class="item-content">
                            <img src="{{asset('public/images/portfolio/img-1.jpg')}}" alt="">
                            <div class="item-overlay">
                                <h6>Application</h6>
                                <div class="icons">
                                    <span class="icon link">
                                        <a href="{{asset('public/images/portfolio/img-1.jpg')}}">
                    ...
                    <div class="col-lg-4 col-md-6 item design">
                        <div class="item-content">
                            <img src="{{asset('public/images/portfolio/img-2.jpg')}}" alt="">
                            <div class="item-overlay">
                                <h6>Web Design</h6>
                                <div class="icons">
                                    <span class="icon link">
                                        <a href="{{asset('public/images/portfolio/img-2.jpg')}}">
                                            <i class="fa fa-search"></i>
                                        </a>
                                    </span>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 item development">
                        <div class="item-content">
                            <img src="{{asset('public/images/portfolio/img-3.jpg')}}" alt="">
                            <div class="item-overlay">
                                <h6>Application</h6>
                                <div class="icons">
                                    <span class="icon link">
                                        <a href="{{asset('public/images/portfolio/img-3.jpg')}}">
                                            <i class="fa fa-search"></i>
                                        </a>
                                    </span>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 item design development">
                        <div class="item-content">
                            <img src="{{asset('public/images/portfolio/img-4.jpg')}}" alt="">
                            <div class="item-overlay">
                                <h6>Development</h6>
                                <div class="icons">
                                    <span class="icon link">
                                        <a href="{{asset('public/images/portfolio/img-4.jpg')}}">
                                            <i class="fa fa-search"></i>
                                        </a>
                                    </span>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 item development application">
                        <div class="item-content">
                            <img src="{{asset('public/images/portfolio/img-5.jpg')}}" alt="">
                            <div class="item-overlay">
                                <h6>Web Design</h6>
                                <div class="icons">
                                    <span class="icon link">
                                        <a href="{{asset('public/images/portfolio/img-5.jpg')}}">
                                            <i class="fa fa-search"></i>
                                        </a>
                                    </span>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 item application development">
                        <div class="item-content">
                            <img src="{{asset('public/images/portfolio/img-6.jpg')}}" alt="">
                            <div class="item-overlay">
                                <h6>Web Design</h6>
                                <div class="icons">
                                    <span class="icon link">
                                        <a href="{{asset('public/images/portfolio/img-6.jpg')}}">
                                            <i class="fa fa-search"></i>
                                        </a>
                                    </span>
                                </div>
                ...
                <div class="row">
                    <div class="owl-carousel owl-theme">
                        ...
                        <div class="blog-item">
                            <div class="blog-img">
                                <a href="single-blog.html">
                                    <img src="{{asset('public/images/blog/img-1.jpg')}}" alt="">
                                </a>
                            </div>
                        ...
                        <div class="blog-item">
                            <div class="blog-img">
                                <a href="single-blog.html">
                                    <img src="{{asset('public/images/blog/img-2.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="blog-content">
                                <h3>The best of web design and web design inspiration</h3>
                        ...
                        <div class="blog-item">
                            <div class="blog-img">
                                <a href="single-blog.html">
                                    <img src="{{asset('public/images/blog/img-3.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="blog-content">
                                <h3>The best of web design and web design inspiration</h3>
                        ...
                        <div class="blog-item">
                            <div class="blog-img">
                                <a href="single-blog.html">
                                    <img src="{{asset('public/images/blog/img-4.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="blog-content">
                                <h3>The best of web design and web design inspiration</h3>
        ...
        <section class="testimonials pt-100 pb-100" style="background-image: url({{asset('public/images/background/testimonials-bg.jpg')}})">
            <div class="container">
                <div class="row">
                        ...
                        <div class="owl-carousel owl-theme text-center">
                            ...
                            <div class="testimonial-item">
                                <div class="author-img">
                                    <img src="{{asset('public/images/testimonial/img-1.jpg')}}" alt="">
                                </div>
                                <h5>Mr John Doe</h5>
